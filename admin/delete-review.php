...
if($res==TRUE){
    ...
    $_SESSION['delete-review']="<div class='success'>Review history Deleted Successfully  </div>";
    //redirect to manage admin page
    header('location:'.SITEURL.'admin/manage-review.php');
}
else{
    //failed to delete admin
    $_SESSION['delete-review']="<div class='error'>Failed TO Deleted review  history</div>";
    //redirect to manage admin page
    header('location:'.SITEURL.'admin/manage-review.php');
}
?>